...
The resulting data object is a SummarizedExperiment object saved as "ZPRIME_1pct.rds" and csv files for sample data ("Assay_annotation"), taxon information ("Assay_taxonomy") and count data ("Assay_count").
